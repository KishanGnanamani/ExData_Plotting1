# This function takes the complete file path of the household_power_consumption.txt file as input parameter and creates the "Plot3.png" in the working directory
# Function invocation example - createPlot3("C:/Users/.../household_power_consumption.txt")
